...
public class MainActivity extends AppCompatActivity {
    ...
    private com.getbase.floatingactionbutton.FloatingActionButton send;
    private com.getbase.floatingactionbutton.FloatingActionButton add;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Asignacion de variables del layput
        send = (com.getbase.floatingactionbutton.FloatingActionButton) findViewById(R.id.accion_Send);
        add = (com.getbase.floatingactionbutton.FloatingActionButton) findViewById(R.id.accion_Add);
        ...
        // Llamada a metodos de listeners
        setListeners();
    }
